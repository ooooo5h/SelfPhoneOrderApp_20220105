...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mStoreList.add(StoreData("피자애", "1899-7600", "https://media.istockphoto.com/vectors/italian-pizza-logo-taste-of-italy-symbol-for-pizzeria-circular-with-vector-id1129190754?s=612x612"))
        mStoreList.add(StoreData("피자에땅", "1688-3651", "https://mblogthumb-phinf.pstatic.net/20160530_214/ppanppane_1464617804922knKn4_PNG/%C7%C7%C0%DA%BF%A1%B6%A5_%B7%CE%B0%ED_%282%29.png?type=w800"))
